...
import 'Presentation/widgets/other_details_.dart';

class Shop2CartView extends StatefulWidget {
  const Shop2CartView({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return Shop2CartViewState();
  }
}

class Shop2CartViewState extends State<Shop2CartView> {
  int number = 1;
