...
class Shop1CartView extends StatefulWidget {
  const Shop1CartView({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return Shop1CartViewState();
  }
}

class Shop1CartViewState extends State<Shop1CartView> {
  int number = 1;
